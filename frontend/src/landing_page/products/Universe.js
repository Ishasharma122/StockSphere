     ...
     <div className="container mt-5 mb-5 ">
       <div className="row text-center">
         ...
         <div className="col-4 p-3 mt-5">
           ...
           <p className="text-small text-muted">Options trading platform that lets you create strategies,analyze positons,and examine data points like open interest,Fll/Dll, and more.</p>
         </div>
         <div className="col-4 p-3 mt-5">
         ...
         <div className="col-4 p-3 mt-5">
           <img src="media\streakLogo.png" style={{width :"200px",height:"150px" }}/>
